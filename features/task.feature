Feature: Task
  ...
  Scenario: Consulto y no hay tareas existentes - get_all
    Given que no hay tareas existentes
    When consulto las tareas
    Then no me muestra ninguna tarea

  Scenario: Camino : Como usuario, quiero poder obtener los datos de una tarea para consultar y comunicar su situación. - get_by_id
  ...
  Scenario: Camino E: Como usuario, quiero poder agregar tareas al sistema para consultar y comunicar su situación. - create
  ...
  Scenario: Camino : Como usuario, quiero poder modificar tareas para actualizar la información. - update
    ...
    Scenario: Como usuario, quiero poder borrar una tarea para evitar tener tareas en desuso.
